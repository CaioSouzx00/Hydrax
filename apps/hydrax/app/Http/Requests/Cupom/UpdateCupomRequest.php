...
class UpdateCupomRequest extends FormRequest
{
     ...
     * Apenas administradores podem atualizar cupons.
     *
     * @return bool
     */
    ...
    /**
     * Regras de validação para atualização de cupom.
     *
    ...
    public function rules(): array
    {
        ...
        return [
            'codigo' => 'required|string|max:50|unique:cupons,codigo,' . $cupomId . ',id_cupom',
