...
class EnderecoUsuarioController extends Controller
{
    ...
    public function definirPrincipal(EnderecoUsuario $endereco)
    {
        $usuario = Auth::guard('usuarios')->user();
        ...
        DB::transaction(function () use ($usuario, $endereco) {
            EnderecoUsuario::where('id_usuarios', $usuario->id_usuarios)
        ...
        return redirect()->back()->with('success', 'Endereço principal atualizado!');
    }
