                ...
                @foreach($produtos as $produto)
                    <div class="glass rounded-2xl overflow-hidden transition-all duration-500 group relative hover:scale-[1.03]">
                        ...
                        <div class="relative w-full h-56 overflow-hidden">
                            ...
                            @php
                                $fotosIa = is_array($produto->fotos ?? null) ? $produto->fotos : json_decode($produto->fotos ?? '[]', true);
                                $fotoIa = is_array($fotosIa) && count($fotosIa) > 0 ? $fotosIa[0] : null;
                            @endphp
                            <img src="{{ $fotoIa ? asset('storage/' . $fotoIa) : 'https://via.placeholder.com/400x400?text=Produto' }}"
