<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6 pt-24 justify-center">
  ...
  @empty
    <p class="text-white text-center col-span-full">Nenhum produto disponível no momento.</p>
  @endforelse
</div>
