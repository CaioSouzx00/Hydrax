<div
  class="bg-[#111]/50 border border-[#222] rounded-xl shadow-lg p-5 w-72 min-h-[420px] mx-auto cursor-pointer hover:border-[#D5891B]/20"
  onclick="abrirDetalhesProduto(this)"
  data-url="{{ route('produtos.detalhes', $produto->id_produtos) }}"
  role="button"
  tabindex="0"
  onkeypress="if(event.key==='Enter'){ abrirDetalhesProduto(this) }"
>
  @php
