            ...
            <div class="w-1/2 bg-black/20 rounded-md flex items-center justify-center p-8">
                <section class="p-6 w-full max-w-sm space-y-4">
                    <div class="text-center mb-6">
                        <h2 class="text-3xl font-[Orbitron] text-indigo-400 mb-2">Verificar Código</h2>
                        <p class="text-sm text-gray-300">Digite o código enviado para o seu e-mail</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('fornecedores.senha.verificar') }}" class="space-y-4">
                        @csrf
